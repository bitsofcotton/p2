...
*/
  ...
  while(std::getline(std::cin, s, '\n')) {
    ...
    lastM = p2next<num_t, true >(lastM, p0.next(d), p1, f0, f1, r0, r1, br0, t);
#else
    lastM = p2next<num_t, false>(lastM, p0.next(d), p1, f0, f1, r0, r1, br0, t);
#endif
    auto& MM(lastM);
    M = MM[0] * MM[1] * MM[2] * MM[3] * MM[4] * MM[5];
