...
clean:
	@rm -rf catgp catgp32 rand rand32 p p32 p64 pheavy pheavy32
all:	catgp catgp32 rand rand32 p p32 p64 pheavy pheavy32
catgp:
...
pheavy64:
	${CXX} ${CXXFLAGS} -static -D_FLOAT_BITS_=64 -o pheavy64 pheavy.cc
