...
p2-2.py makes uncontinuous series to pseudo-continuous, if minimum square tilt gently changes than original values, the recursive of this could make it better results.
