...
XXX: but if we input finite exponent and finite mantissa bits, with infinite accuracy computer, we can make the status dimension into 1 dimension at all, so in this case, valren == 2 on p1 and catg.
